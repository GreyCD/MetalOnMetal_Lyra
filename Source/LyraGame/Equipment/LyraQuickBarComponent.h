...
public:
	...
	UFUNCTION(BlueprintCallable, Category="Lyra")
	AActor* CycleActiveSlotForwardReturnActor();
	
	UFUNCTION(BlueprintCallable, Category="Lyra")
	AActor* CycleActiveSlotBackwardReturnActor();
	...
	//@TODO: bringfire games -- This is a temporary function to get the first equipped actor. It will be replaced with a more robust system later.
	UFUNCTION(BlueprintCallable, Category="Equipment")
	AActor* GetFirstEquippedActor() const;

	UFUNCTION(BlueprintCallable, Category="Equipment")
	AActor* GetEquippedActorForSlot(int32 SlotIndex) const;

	UFUNCTION(BlueprintCallable, Category="Equipment")
	int32 CountLoadedItems() const;
