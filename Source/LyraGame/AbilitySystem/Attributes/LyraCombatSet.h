...
public:
	...
	ATTRIBUTE_ACCESSORS(ULyraCombatSet, BaseArmor);
...
protected:
	...
	UFUNCTION()
	void OnRep_BaseArmor(const FGameplayAttributeData& OldValue);
...
private:
	...
	// The base of armor .
	UPROPERTY(BlueprintReadOnly, ReplicatedUsing = OnRep_BaseArmor, Category = "Lyra|Combat", Meta = (AllowPrivateAccess = true))
