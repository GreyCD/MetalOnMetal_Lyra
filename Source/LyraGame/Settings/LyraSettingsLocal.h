...
public:
	...
	//@TODO: bringfire games -- This is a setting to load settings after all modules have loaded. This is a temporary solution.
	/*void OnAllModuleLoadingPhasesComplete();
	FDelegateHandle OnAllModuleLoadingPhasesCompleteHandle;

	UFUNCTION()
	static bool IsDLSSSupported() { return UDLSSLibrary::IsDLSSSupported(); }
    
	UFUNCTION()
	static bool IsDLSSEnabled() { return UDLSSLibrary::IsDLSSEnabled(); }
	UFUNCTION()
	static void SetDLSSEnabled(bool bEnabled) { UDLSSLibrary::EnableDLSS(bEnabled); }

	UFUNCTION()
	static UDLSSMode GetDLSSMode() { return UDLSSLibrary::GetDLSSMode(); }
	UFUNCTION()
	void SetDLSSMode(const UDLSSMode InMode) { DLSSMode = InMode; ApplyDLSSMode(); }
