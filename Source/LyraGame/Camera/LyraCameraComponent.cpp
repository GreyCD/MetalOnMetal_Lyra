...
void ULyraCameraComponent::SetShiftLens(float InShiftLens)
{
	ShiftLens = InShiftLens;
}

void ULyraCameraComponent::UpdateShiftLens()
{
	// Update shift lens for all player controllers
...
void ULyraCameraComponent::GetCameraView(float DeltaTime, FMinimalViewInfo& DesiredView)
{
	...
	// Update shift lens
	DesiredView.OffCenterProjectionOffset.Y = ShiftLens;
	UpdateShiftLens();
