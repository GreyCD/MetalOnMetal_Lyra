...
public:
	...
	UPROPERTY(BlueprintReadWrite, Category = SimData, AdvancedDisplay, meta = (Units = "meters"))
...
public:
	...
	UPROPERTY(BlueprintReadWrite, Category = SimData, AdvancedDisplay)
	...
	void GenerateId()
	{
		if(!HasBeenAssignedId || !Id.IsValid())
		{
			Id.Generate();
...
public:
	...
	TFunction<TB::BulletPenFunc> CustomPenetrationFunction;
