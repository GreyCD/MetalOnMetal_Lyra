...
#include "TBStatics.generated.h"


class UBulletDataAsset;
struct FOverlapResult;
struct FTBCollisionParams;
struct FTBOverlapArray;
...
namespace TB
{
	...
	bool DoesShapeOverlap(const FHitResult& HitResult, const FVector& Location, const FCollisionShape& CollisionShape, const FQuat& Rot = FQuat::Identity, const int32 PreviousShapeIndex = -1);
...
#pragma endregion
	...
	* @param TracerActivationDistance	How far the projectile must travel before its tracer becomes active (m).
	* @param Payload					Additional custom information to be stored with this bullet.
	*/
	UFUNCTION(BlueprintPure, Category = "Terminal Ballistics|Utility", meta = (AdvancedDisplay = "OwnerIgnoreDistance, TracerActivationDistance, Payload", AutoCreateRefTerm = "ToIgnore, ObjectTypes", NativeMakeFunc, BlueprintThreadSafe,
		TraceChannel = "ECC_GameTraceChannel10", bIgnoreOwner = "true", bAddToOwnerVelocity = "true", bForceNoTracer = "false", ProjectileSpeed = "360", EffectiveRange = "150", Timescale = "1", DefaultToSelf = "Owner",
	...
	* @param Payload			Additional custom information to be stored with this bullet.
	*/
	UFUNCTION(BlueprintPure, Category = "Terminal Ballistics|Utility", meta = (AdvancedDisplay = "OwnerIgnoreDistance, TracerActivationDistance, Payload", AutoCreateRefTerm = "ToIgnore, ObjectTypes", NotBlueprintThreadSafe,
		TraceChannel = "ECC_GameTraceChannel10", bIgnoreOwner = "true", bAddToOwnerVelocity = "true", bForceNoTracer = "false", ProjectileSpeed = "360", EffectiveRange = "150", Timescale = "1", DefaultToSelf = "Owner",
		ObjectTypes = "{TEnumAsByte<EObjectTypeQuery>(0), TEnumAsByte<EObjectTypeQuery>(1), EnumAsByte<EObjectTypeQuery>(2), TEnumAsByte<EObjectTypeQuery>(3), TEnumAsByte<EObjectTypeQuery>(5)}"
	))
	...
	* @param Payload					Additional custom information to be stored with this bullet.
	*/
	UFUNCTION(BlueprintPure, Category = "Terminal Ballistics|Utility", meta = (AdvancedDisplay = "OwnerIgnoreDistance, TracerActivationDistance, Payload", NativeBreakFunc, BlueprintThreadSafe))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Terminal Ballistics|Projectiles", meta = (AdvancedDisplay = "DebugType, Id", AutoCreateRefTerm = "LaunchParams, Id", ReturnDisplayName = "Id", UnsafeDuringActorConstruction))
	static FTBProjectileId AddAndFireBullet(TSoftObjectPtr<UBulletDataAsset> Bullet, UPARAM(Ref)FTBLaunchParams& LaunchParams, const FTBProjectileId& Id, UPARAM(meta = (Bitmask, BitmaskEnum = "/Script/TerminalBallistics.ETBBallisticsDebugType")) int32 DebugType = 0);
	/**
	* @param Id		Used to override the autogenerated Id. Useful when you need to sync Ids across client and server. Use with caution, as duplicate Ids can result in unwanted behavior.
	*/
	UFUNCTION(BlueprintCallable, Category = "Terminal Ballistics|Projectiles", meta = (AdvancedDisplay = "DebugType, Id", AutoCreateRefTerm = "LaunchParams, Id", ReturnDisplayName = "Id", UnsafeDuringActorConstruction))
	static FTBProjectileId AddAndFireBulletWithCallbacks(TSoftObjectPtr<UBulletDataAsset> Bullet, UPARAM(Ref)FTBLaunchParams& LaunchParams, FBPOnProjectileComplete OnBulletComplete, FBPOnBulletHit OnBulletHit, FBPOnBulletExitHit OnBulletExitHit, FBPOnBulletInjure OnBulletInjure, const FTBProjectileId& Id, UPARAM(meta = (Bitmask, BitmaskEnum = "/Script/TerminalBallistics.ETBBallisticsDebugType")) int32 DebugType = 0);
	/**
	* @param Id		Used to override the autogenerated Id. Useful when you need to sync Ids across client and server. Use with caution, as duplicate Ids can result in unwanted behavior.
	*/
	UFUNCTION(BlueprintCallable, Category = "Terminal Ballistics|Projectiles", meta = (AdvancedDisplay = "DebugType, Id", AutoCreateRefTerm = "LaunchParams, Id", ReturnDisplayName = "Id", UnsafeDuringActorConstruction))
	static FTBProjectileId AddAndFireBulletWithCallbacksAndUpdate(TSoftObjectPtr<UBulletDataAsset> Bullet, UPARAM(Ref)FTBLaunchParams& LaunchParams, FBPOnProjectileComplete OnBulletComplete, FBPOnBulletHit OnBulletHit, FBPOnBulletExitHit OnBulletExitHit, FBPOnBulletInjure OnBulletInjure, FBPOnProjectileUpdate OnUpdate, const FTBProjectileId& Id, UPARAM(meta = (Bitmask, BitmaskEnum = "/Script/TerminalBallistics.ETBBallisticsDebugType")) int32 DebugType = 0);

	UFUNCTION(BlueprintCallable, Category = "Terminal Ballistics|Projectiles", meta = (AdvancedDisplay = "DebugType", AutoCreateRefTerm = "LaunchParams", ReturnDisplayName = "Id", UnsafeDuringActorConstruction))
	static TArray<FTBProjectileId> AddAndFireMultiProjectileBullet(TSoftObjectPtr<UBulletDataAsset> Bullet, UPARAM(Ref)FTBLaunchParams& LaunchParams, UPARAM(meta = (Bitmask, BitmaskEnum = "/Script/TerminalBallistics.ETBBallisticsDebugType")) int32 DebugType = 0);

	/**
	* @param Id		Used to override the autogenerated Id. Useful when you need to sync Ids across client and server. Use with caution, as duplicate Ids can result in unwanted behavior.
	*/
	UFUNCTION(BlueprintCallable, Category = "Terminal Ballistics|Projectiles", meta = (AdvancedDisplay = "DebugType, Id, Instigator", AutoCreateRefTerm = "LaunchParams, Id", ReturnDisplayName = "Id", UnsafeDuringActorConstruction))
	static FTBProjectileId AddAndFireProjectile(const FTBProjectile& Projectile, const FPhysMatProperties& ProjectilePhysicalProperties, UPARAM(Ref)FTBLaunchParams& LaunchParams, const FTBProjectileId& Id, UPARAM(meta = (Bitmask, BitmaskEnum = "/Script/TerminalBallistics.ETBBallisticsDebugType"))  int32 DebugType = 0);
	/**
	* @param Id		Used to override the autogenerated Id. Useful when you need to sync Ids across client and server. Use with caution, as duplicate Ids can result in unwanted behavior.
	*/
	UFUNCTION(BlueprintCallable, Category = "Terminal Ballistics|Projectiles", meta = (AdvancedDisplay = "DebugType, Id, Instigator", AutoCreateRefTerm = "LaunchParams, Id", ReturnDisplayName = "Id", UnsafeDuringActorConstruction))
	static FTBProjectileId AddAndFireProjectileWithCallbacks(const FTBProjectile& Projectile, const FPhysMatProperties& ProjectilePhysicalProperties, UPARAM(Ref)FTBLaunchParams& LaunchParams, FBPOnProjectileComplete OnProjectileComplete, FBPOnProjectileHit OnProjectileHit, FBPOnProjectileExitHit OnProjectileExitHit, FBPOnProjectileInjure OnProjectileInjure, const FTBProjectileId& Id, UPARAM(meta = (Bitmask, BitmaskEnum = "/Script/TerminalBallistics.ETBBallisticsDebugType"))  int32 DebugType = 0);
	/**
	* @param Id		Used to override the autogenerated Id. Useful when you need to sync Ids across client and server. Use with caution, as duplicate Ids can result in unwanted behavior.
	*/
	UFUNCTION(BlueprintCallable, Category = "Terminal Ballistics|Projectiles", meta = (AdvancedDisplay = "DebugType, Id, Instigator", AutoCreateRefTerm = "LaunchParams, Id", ReturnDisplayName = "Id", UnsafeDuringActorConstruction))
	static FTBProjectileId AddAndFireProjectileWithCallbacksAndUpdate(const struct FTBProjectile& Projectile, const FPhysMatProperties& ProjectilePhysicalProperties, UPARAM(Ref)FTBLaunchParams& LaunchParams, FBPOnProjectileComplete OnProjectileComplete, FBPOnProjectileHit OnProjectileHit, FBPOnProjectileExitHit OnProjectileExitHit, FBPOnProjectileInjure OnProjectileInjure, FBPOnProjectileUpdate OnUpdate, const FTBProjectileId& Id, UPARAM(meta = (Bitmask, BitmaskEnum = "/Script/TerminalBallistics.ETBBallisticsDebugType"))  int32 DebugType = 0);
	/**
	* @param Id		Used to override the autogenerated Id. Useful when you need to sync Ids across client and server. Use with caution, as duplicate Ids can result in unwanted behavior.
	*/
	UFUNCTION(BlueprintCallable, Category = "Terminal Ballistics|Projectiles", meta = (AdvancedDisplay = "DebugType, Ids", AutoCreateRefTerm = "LaunchParams, Ids, Instigator", ReturnDisplayName = "Ids", UnsafeDuringActorConstruction))
	static TArray<FTBProjectileId> AddAndFireProjectiles(TArray<FTBProjectile> Projectiles, const FPhysMatProperties& ProjectilePhysicalProperties, TArray<FTBLaunchParams> LaunchParams, UPARAM(Ref)TArray<FTBProjectileId>& Ids, UPARAM(meta = (Bitmask, BitmaskEnum = "/Script/TerminalBallistics.ETBBallisticsDebugType"))  int32 DebugType = 0);
	UFUNCTION(BlueprintCallable, Category = "Terminal Ballistics|Projectiles", meta = (AdvancedDisplay = "DebugType, Ids", AutoCreateRefTerm = "LaunchParams, Ids, Instigator", ReturnDisplayName = "Ids", UnsafeDuringActorConstruction))
	static TArray<FTBProjectileId> AddAndFireProjectilesWithCallbacks(TArray<FTBProjectile> Projectiles, const FPhysMatProperties& ProjectilePhysicalProperties, TArray<FTBLaunchParams> LaunchParams, UPARAM(Ref)TArray<FTBProjectileId>& Ids, FBPOnProjectileComplete OnProjectileComplete, FBPOnProjectileHit OnProjectileHit, FBPOnProjectileExitHit OnProjectileExitHit, FBPOnProjectileInjure OnProjectileInjure, UPARAM(meta = (Bitmask, BitmaskEnum = "/Script/TerminalBallistics.ETBBallisticsDebugType"))  int32 DebugType = 0);
	UFUNCTION(BlueprintCallable, Category = "Terminal Ballistics|Projectiles", meta = (AdvancedDisplay = "DebugType, Ids", AutoCreateRefTerm = "LaunchParams, Ids, Instigator", ReturnDisplayName = "Ids", UnsafeDuringActorConstruction))
	static TArray<FTBProjectileId> AddAndFireProjectilesWithCallbacksAndUpdate(TArray<FTBProjectile> Projectiles, const FPhysMatProperties& ProjectilePhysicalProperties, TArray<FTBLaunchParams> LaunchParams, UPARAM(Ref)TArray<FTBProjectileId>& Ids, FBPOnProjectileComplete OnProjectileComplete, FBPOnProjectileHit OnProjectileHit, FBPOnProjectileExitHit OnProjectileExitHit, FBPOnProjectileInjure OnProjectileInjure, FBPOnProjectileUpdate OnUpdate, UPARAM(meta = (Bitmask, BitmaskEnum = "/Script/TerminalBallistics.ETBBallisticsDebugType"))  int32 DebugType = 0);
	...
	*/
	...
	static FTBProjectileId AddAndFireTestBullet(TSoftObjectPtr<UBulletDataAsset> Bullet, UPARAM(Ref)FTBLaunchParams& LaunchParams, TArray<FPredictProjectilePathPointData>& Results, FLatentActionInfo LatentInfo, const FTBProjectileId& Id);
	static TArray<FPredictProjectilePathPointData> AddAndFireTestBullet(TSoftObjectPtr<UBulletDataAsset> Bullet, FTBLaunchParams& LaunchParams, const FTBProjectileId& Id = FTBProjectileId::None);
	...
	*/
	...
	UFUNCTION(BlueprintCallable, Category = "Terminal Ballistics|Utility")
	...
	{
		return TB::MathUtils::VectorUtils::VRandConeGuassian(Direction, HorizontalConeHalfAngleRad, VerticalConeHalfAngleRad);
	}

	/**
	* Attempts to convert the given object into a UObject, suitable for use as a projectile payload.
	* Only types derived from UObject will work, so be sure to check for validity.
	*/
	UFUNCTION(BlueprintPure, Category = "Terminal Ballistics|Utility", CustomThunk, meta = (HideAssetPicker = "Object", CustomStructureParam = "Object"))
	static UObject* MakePayload(UProperty* Object, bool& Success);

	DECLARE_FUNCTION(execMakePayload);
};
