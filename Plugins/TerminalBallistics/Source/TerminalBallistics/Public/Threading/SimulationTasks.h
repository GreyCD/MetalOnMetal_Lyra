...
namespace TB::SimTasks
{
	...
	public:
		...
		virtual FTBBullet& GetProjectile() override
		{
			return *Bullet;
		}
	...
	protected:
		...
		virtual FVector CalculateProjectileVelocityInCavityFormingPhase(const FVector& Velocity, FVector& ExitLocation);

		TUniqueFunction<TB::BulletPenFunc> CustomPenetrationFunction;
	};
	...
	public:
		...
		virtual FTBProjectile& GetProjectile() override
		{
