...
public:
	...
	// The name of this physical material.
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "Terminal Ballistics|PhysMatManager")
	bool ImplementsDynamicMaterialPropertyManager(UObject* Object) const;
	...
	// Attempts to remove a mapping. Returns true if successful.
	bool RemoveEntry(const FGameplayTag& Tag);
