...
#include "TBConfiguration.generated.h"
...
public:
	...
	UPROPERTY(Config, EditAnywhere, BlueprintReadOnly, Category = "Ballistics", meta = (InvalidEnumValues = "DEFAULT"))
	...
	UPROPERTY(Config, EditAnywhere, BlueprintReadOnly, Category = "Ballistics", AdvancedDisplay, meta = (Min = "8", ToolTip = "Amount of memory to available to each worker thread. (KiB)\nWarning: Changing this value should be done with caution. Too little memory will result in a stack overflow.", ConsoleVariable = "tb.Thread.WorkerThreadStackSize"))
