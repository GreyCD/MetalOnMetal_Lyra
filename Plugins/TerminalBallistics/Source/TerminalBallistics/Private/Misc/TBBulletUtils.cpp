...
FTBBulletPhysicalProperties UBulletUtils::GetBulletFromType(ETBBulletCaliber Type)
{
	...
	case ETBBulletCaliber::Bullet_12Gauge:	return BULLET_12Gauge00Buck;
...
FTBBullet UBulletUtils::GetFullBulletFromType(ETBBulletCaliber Type, TArray<ETBBulletVariation> Variation)
{
	...
	case ETBBulletCaliber::Bullet_300WINMAG:	return types.Bullet_300WinMag;
	...
	case ETBBulletCaliber::Bullet_12Gauge:		return types.Bullet_12Gauge00Buckshot;
...
FTBBullet UBulletUtils::GetFullBulletFromName(ETBBulletNames Name)
{
	...
	return GetFullBulletFromName(Name, bFoundBullet);
}

FTBBullet UBulletUtils::GetFullBulletFromName(ETBBulletNames Name, bool& bFoundBullet)
{
	using namespace TB::Bullets;
	bFoundBullet = false;
	BulletTypes types = BulletTypes::Get();
...
{
	bool bFoundBullet = false;
	return GetNameFromBullet(Bullet, bFoundBullet);
}

ETBBulletNames UBulletUtils::GetNameFromBullet(const FTBBullet& Bullet, bool& bFoundBullet)
{
	using namespace TB::Bullets;
	bFoundBullet = false;
...
double UBulletUtils::GetTypicalMuzzleVelocityForBullet(const ETBBulletCaliber Caliber)
{
	...
	case ETBBulletCaliber::Bullet_300WHSP:
		return 0.0;
	case ETBBulletCaliber::Bullet_300WINMAG:	return 980;
	...
	case ETBBulletCaliber::Bullet_357SIG:
		return 0.0;
	case ETBBulletCaliber::Bullet_12Gauge:		return 373.38;
	default:
		return 0.0;
	}
}
...
double UBulletUtils::GetTypicalEffectiveRangeForBullet(const ETBBulletCaliber Caliber)
{
	...
	case ETBBulletCaliber::Bullet_300WHSP:
		return DEFAULT_RANGE;
	case ETBBulletCaliber::Bullet_300WINMAG:	return 1200;
	case ETBBulletCaliber::Bullet_408:
		return DEFAULT_RANGE;
	case ETBBulletCaliber::Bullet_416:
		return DEFAULT_RANGE;
	...
	case ETBBulletCaliber::Bullet_357SIG:
		return DEFAULT_RANGE;
	case ETBBulletCaliber::Bullet_12Gauge:		return 50.0;
	default:
		return DEFAULT_RANGE;
	}
}
