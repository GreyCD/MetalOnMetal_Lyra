...
#include "MoviePipelineDeferredShiftPasses.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(MoviePipelineDeferredShiftPasses)

FString UMoviePipelineDeferredShiftPassBase::StencilLayerMaterialAsset = TEXT("/MovieRenderPipeline/Materials/MoviePipeline_StencilCutout.MoviePipeline_StencilCutout");
FString UMoviePipelineDeferredShiftPassBase::DefaultDepthAsset = TEXT("/MovieRenderPipeline/Materials/MovieRenderQueue_WorldDepth.MovieRenderQueue_WorldDepth");
FString UMoviePipelineDeferredShiftPassBase::DefaultMotionVectorsAsset = TEXT("/MovieRenderPipeline/Materials/MovieRenderQueue_MotionVectors.MovieRenderQueue_MotionVectors");



UMoviePipelineDeferredShiftPassBase::UMoviePipelineDeferredShiftPassBase() 
	: UMoviePipelineImageShiftPassBase()
{
	...
	{
		FMoviePipelinePostProcessShiftPass& NewPass = AdditionalPostProcessMaterials.AddDefaulted_GetRef();
...
FIntPoint UMoviePipelineDeferredShiftPassBase::GetEffectiveOutputResolutionForCamera(const int32 InCameraIndex) const
{
...
FMoviePipelineRenderPassMetrics UMoviePipelineDeferredShiftPassBase::GetRenderPassMetricsForCamera(const int32 InCameraIndex, const FMoviePipelineRenderPassMetrics& InSampleState) const
{
...
int32 UMoviePipelineDeferredShiftPassBase::GetNumCamerasToRender() const
{
	UMoviePipelineExecutorShot* CurrentShot = GetPipeline()->GetActiveShotList()[GetPipeline()->GetCurrentShotIndex()];
...
FString UMoviePipelineDeferredShiftPassBase::GetCameraName(const int32 InCameraIndex) const
{
	UMoviePipelineExecutorShot* CurrentShot = GetPipeline()->GetActiveShotList()[GetPipeline()->GetCurrentShotIndex()];
...
FString UMoviePipelineDeferredShiftPassBase::GetCameraNameOverride(const int32 InCameraIndex) const
{
	// Custom camera name used to override ouput file name param
	return TEXT("");
}

void UMoviePipelineDeferredShiftPassBase::MoviePipelineRenderShowFlagOverride(FEngineShowFlags& OutShowFlag)
{
...
void UMoviePipelineDeferredShiftPassBase::SetupImpl(const MoviePipeline::FMoviePipelineRenderPassInitSettings& InPassInitSettings)
{
	...
	for (FMoviePipelinePostProcessShiftPass& AdditionalPass : AdditionalPostProcessMaterials)
	{
...
void UMoviePipelineDeferredShiftPassBase::TeardownImpl()
{
...
void UMoviePipelineDeferredShiftPassBase::AddReferencedObjects(UObject* InThis, FReferenceCollector& Collector)
{
	Super::AddReferencedObjects(InThis, Collector);

	UMoviePipelineDeferredShiftPassBase& This = *CastChecked<UMoviePipelineDeferredShiftPassBase>(InThis);
...
FSceneViewStateInterface* UMoviePipelineDeferredShiftPassBase::GetSceneViewStateInterface(IViewCalcPayload* OptPayload)
{
...
void UMoviePipelineDeferredShiftPassBase::GatherOutputPassesImpl(TArray<FMoviePipelinePassIdentifier>& ExpectedRenderPasses)
{
...
void UMoviePipelineDeferredShiftPassBase::AddViewExtensions(FSceneViewFamilyContext& InContext, FMoviePipelineRenderPassMetrics& InOutSampleState)
{
...
void UMoviePipelineDeferredShiftPassBase::RenderSample_GameThreadImpl(const FMoviePipelineRenderPassMetrics& InSampleState)
{
...
TFunction<void(TUniquePtr<FImagePixelData>&&)> UMoviePipelineDeferredShiftPassBase::MakeForwardingEndpoint(const FMoviePipelinePassIdentifier InPassIdentifier, const FMoviePipelineRenderPassMetrics& InSampleState)
{
...
UE::MoviePipeline::FImagePassCameraViewData UMoviePipelineDeferredShiftPassBase::GetCameraInfo(FMoviePipelineRenderPassMetrics& InOutSampleState, IViewCalcPayload* OptPayload) const
{
	UMoviePipelineExecutorShot* CurrentShot = GetPipeline()->GetActiveShotList()[GetPipeline()->GetCurrentShotIndex()];
	const int32 NumCameras = GetNumCamerasToRender();
...
void UMoviePipelineDeferredShiftPassBase::BlendPostProcessSettings(FSceneView* InView, FMoviePipelineRenderPassMetrics& InOutSampleState, IViewCalcPayload* OptPayload)
{
	UMoviePipelineExecutorShot* CurrentShot = GetPipeline()->GetActiveShotList()[GetPipeline()->GetCurrentShotIndex()];
	const int32 NumCameras = GetNumCamerasToRender();
...
void UMoviePipelineDeferredShiftPassBase::PostRendererSubmission(const FMoviePipelineRenderPassMetrics& InSampleState, const FMoviePipelinePassIdentifier InPassIdentifier, const int32 InSortingOrder, FCanvas& InCanvas)
{
	// If this was just to contribute to the history buffer, no need to go any further.
...
bool UMoviePipelineDeferredShiftPassBase::IsAutoExposureAllowed(const FMoviePipelineRenderPassMetrics& InSampleState) const
{
...
#if WITH_EDITOR
FText UMoviePipelineDeferredShiftPass_PathTracer::GetFooterText(UMoviePipelineExecutorJob* InJob) const {
	return NSLOCTEXT(
		"MovieRenderPipeline",
		"DeferredBasePassSetting_FooterText_PathTracerShiftLens",
...
bool UMoviePipelineDeferredShiftPassBase::CheckIfPathTracerIsSupported() const
{
...
void UMoviePipelineDeferredShiftPassBase::PathTracerValidationImpl()
{
...
void UMoviePipelineDeferredShiftPass_PathTracer::ValidateStateImpl()
{
	Super::ValidateStateImpl();
	PathTracerValidationImpl();
}

void UMoviePipelineDeferredShiftPass_PathTracer::SetupImpl(const MoviePipeline::FMoviePipelineRenderPassInitSettings& InPassInitSettings)
{
...
bool UMoviePipelineDeferredShiftPassBase::IsUsingDataLayers() const
{
...
int32 UMoviePipelineDeferredShiftPassBase::GetNumStencilLayers() const
{
	if (IsUsingDataLayers())
	{
...
TArray<FString> UMoviePipelineDeferredShiftPassBase::GetStencilLayerNames() const
{
	return UniqueStencilLayerNames;
}

FSoftObjectPath UMoviePipelineDeferredShiftPassBase::GetValidDataLayerByIndex(const int32 InIndex) const
{
...
bool UMoviePipelineDeferredShiftPassBase::IsActorInLayer(AActor* InActor, int32 InLayerIndex) const
{
	if (IsUsingDataLayers())
	{
...
bool UMoviePipelineDeferredShiftPassBase::IsActorInAnyStencilLayer(AActor* InActor) const
{
	bool bInLayer = false;
	if (IsUsingDataLayers())
	{
