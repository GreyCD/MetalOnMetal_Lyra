...
#include "MoviePipelineDeferredShiftPasses.generated.h"
...
struct FMoviePipelinePostProcessShiftPass
{
	GENERATED_BODY()
...
class UMoviePipelineDeferredShiftPassBase : public UMoviePipelineImageShiftPassBase
{
	GENERATED_BODY()

public:
	UMoviePipelineDeferredShiftPassBase();
...
#if WITH_EDITOR
	virtual FText GetDisplayText() const override { return NSLOCTEXT("MovieRenderPipeline", "DeferredBasePassSetting_DisplayName_ShiftLens", "Deferred Rendering (Shift Lens)"); }
#endif
...
public:
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Deferred Renderer Data")
	TArray<FMoviePipelinePostProcessShiftPass> AdditionalPostProcessMaterials;
...
UCLASS(BlueprintType)
class UMoviePipelineDeferredShiftPass_PathTracer : public UMoviePipelineDeferredShiftPassBase
{
	GENERATED_BODY()

public:
	UMoviePipelineDeferredShiftPass_PathTracer() : UMoviePipelineDeferredShiftPassBase()
	{
		PassIdentifier = FMoviePipelinePassIdentifier("PathTracer");
	}
#if WITH_EDITOR
	virtual FText GetDisplayText() const override { return NSLOCTEXT("MovieRenderPipeline", "DeferredBasePassSetting_DisplayName_PathTracerShiftLens", "Path Tracer (Shift Lens)"); }
