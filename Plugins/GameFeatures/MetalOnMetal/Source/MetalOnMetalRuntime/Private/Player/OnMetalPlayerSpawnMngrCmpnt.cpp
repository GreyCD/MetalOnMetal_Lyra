...
#include "Player/OnMetalPlayerSpawnMngrCmpnt.h"
...
AActor* UOnMetalPlayerSpawnMngrCmpnt::OnChoosePlayerStart(AController* Player, TArray<ALyraPlayerStart*>& PlayerStarts)
{
